          ...
          <form className="space-y-4" onSubmit={handleSaveProfile}>
            ...
            <div className="flex flex-col items-start gap-3">
              ...
              >
                ...
                <div className="group/cover relative">
                  <img
                    src={
                      editFrom.cover_photo
                        ? URL.createObjectURL(editFrom.cover_photo)
                        : user.cover_photo
                    }
                    alt=""
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditForm({ ...editFrom, full_name: e.target.value })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditForm({ ...editFrom, username: e.target.value })
                }
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setEditForm({ ...editFrom, bio: e.target.value })
                }
                value={editFrom.bio}
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditForm({ ...editFrom, location: e.target.value })
                }
            ...
            <div className="flex justify-end space-x-3 pt-6">
              ...
              <button type="submit" className="px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white rounded-lg transition cursor-pointer">
                Save Changes
              </button>
            </div>
          </form>
