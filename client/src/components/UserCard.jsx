  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        />
        <p className="mt-4 font-medium">{user.full_name}</p>
        {user.username && (
      ...
      <div className="flex mt-4 gap-2">
        ...
        <button className="flex items-center justify-center border w-16 text-slate-500 group rounded-md cursor-pointer active:scale-95 transition">
